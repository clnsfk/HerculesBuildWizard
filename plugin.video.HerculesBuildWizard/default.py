...
ADDON=xbmcaddon.Addon(id='plugin.video.HerculesBuildWizard’)
dialog = xbmcgui.Dialog()    
VERSION = "1.0.1"
PATH = “HerculesBuildWizard"            

    
def CATEGORIES():
    link = OPEN_URL('https://copy.com/S1nTj9Eo2uJWTcON/HerculesBuildWizard.txt?download=1').replace('\n','').replace('\r','')
